...
export default function FloatingWhatsApp() {
  ...
  const whatsappUrl = `https://wa.me/${STATUS.whatsappNumber}?text=Hello%20MISASA%2C%20I%27d%20like%20to%20book%20a%20job.`;
  ...
  return (
    <>
      <a
        ...
        style={{
          position: "fixed",
          bottom: "5.5rem",  /* above sticky mobile bar */
          right: "1.25rem",
          zIndex: 95,
          width: "56px",
          height: "56px",
      ...
      <style>{`
        ...
        @media (max-width: 819px) {
          /* On mobile, sit above the sticky call bar (80px) */
